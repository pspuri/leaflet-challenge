...
var myMap = L.map("map", {
  ...
  "access_token=pk.eyJ1IjoicHNwdXJpIiwiYSI6ImNrNGFpczRrZDA0Y20zcG1tam81cjJuM3gifQ.YGz8U7VS9F0ikvIw9d1H1g").addTo(myMap);
  ...
  // set up a title at the top of the map 

//   var title = L.control({position: 'top'});
